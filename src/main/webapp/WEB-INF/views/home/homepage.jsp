...
<body>
    <div class="home-page">
        <nav class="navbar">
            <ul class="nav-links">
                <li><a th:href="@{/Movie}">영화</a></li>
                <li><a th:href="@{/cinema}">극장</a></li>
                <li><a th:href="@{/ticket}">예매</a></li>
...
<!--         <nav class="navbar">
            <ul class="nav-links">
                <li><a th:href="@{/Movie}">무비차트</a></li>
                <li><a th:href="@{/cinema}">상영예정작</a></li>
                <li><a th:href="@{/all-movies}">전체보기</a></li>
            </ul>
        </nav> -->
    </div>
