            ...
            <div>
                ...
                <div>
                    <form method=post action='/ProfileUpdate'>
                        <table>
                        <tr><td></td><td><input type=text name=id id=id></td></tr>
                        <tr><td>아이디</td><td><input type=text name=uid id=uid readonly></td></tr>
                        ...
                        <tr><td>실명</td><td><input type=text name=realname id=realname readonly></td></tr>
                        <tr><td>닉네임</td><td><input type="text" name="nickname" id=inputNickname></td></tr>
                        <tr><td>e-mail</td><td><input type=text name=email id=email></td></tr>
                        <tr><td>주소</td><td><input type=text name=region id=region></td></tr>
                        <tr><td>생년월일</td><td><input type="date" name=birthday id=birthday></td></tr>
                        <tr><td>통신사</td><td> <input type=radio name=tellecom value="LG U+" id="radioLG">LG U+
                            <input type=radio name=tellecom value=KT id="radioKT">KT
                            <input type=radio name=tellecom value=SKT id="radioSKT">SKT<br></td></tr>
                        <tr><td>휴대폰 번호</td><td><input type=text name=mobile id=mobile></td></tr>
                        ...
                        <tr>
                            <td>관심분야</td><td>
                             ...
                             <input type="checkbox" name="favorite" id="favoriteMusic" value="음악">음악
